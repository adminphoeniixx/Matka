...
<div class="container">
    <div class="row">
          <form action="{{route('voyager.dashboard')}}" method="get" >
          <div class="col-md-4 form-group">
            <label> From Date: </label>
            <input type="date" value="{{$fromdate_input}}" required="true" class="form-control" name="fromdate">
          </div>

          <div class="col-md-4 form-group">
            <label> To Date: </label>
            <input type="date" value="{{$todate_input}}" required="true" class="form-control" name="todate">
          </div>
        ...
        <div   class="row ">
            ...
            <div  class="col-md-3">
                ...
                <div class="col">
                <div class="counter">
                      <i class="voyager-people fa-2x"></i>
                      <h2 class="timer count-title count-number" data-to="{{$user_count}}" data-speed="1500"></h2>
                       <p class="count-text ">User Joined</p>
                    </div>
                </div>
                </div>
                </a>
            ...
            <div  class="col-md-3">
                 <div class="card">
                    <a href="{{route('voyager.live-games.index')}}">
                <div class="row text-center">
                <div class="col">
                <div class="counter">
                      <i class="voyager-play fa-2x"></i>
                      <h2 class="timer count-title count-number" data-to="{{$betting_count_jodi}}" data-speed="1500"></h2>
                       <p class="count-text ">User Played Jodi</p>
                    </div>
                </div>
                </div>
            </a>
             ...
             <div  class="col-md-3">
                ...
                <div class="counter">
                      <i class="voyager-play fa-2x"></i>
                      <h2 class="timer count-title count-number" data-to="{{$betting_count_crossing}}" data-speed="1500"></h2>
                       <p class="count-text ">User Played Crossing</p>
                    </div>
                </div>
                </div>
            </a>
            ...
            <div  class="col-md-3">
                ...
                <div class="col">
                <div class="counter">
                      <i class="voyager-double-down fa-2x"></i>
                      <h2 class="timer count-title count-number" data-to="{{$deposit_count}}" data-speed="1500"> ₹ </h2>
                       <p class="count-text ">Amount Deposited</p>
                    </div>
                </div>
                </div>
                </a>
            ...
            <div  class="col-md-3">
                 <div class="card">
                    <a href="{{route('voyager.winners.index')}}">
                <div class="row text-center">
                <div class="col">
                <div class="counter">
                      <i class="voyager-trophy fa-2x"></i>
                      <h2 class="timer count-title count-number" data-to="{{$winnners_count}}" data-speed="1500">  </h2>
                       <p class="count-text ">Users Won</p>
                    </div>
                </div>
                </div>
            </a>
            ...
            <div  class="col-md-3">
                ...
                <div class="col">
                <div class="counter">
                      <i class="voyager-double-up fa-2x"></i>
                      <h2 class="timer count-title count-number" data-to="{{$winnners_amount}}" data-speed="1500"> ₹ </h2>
                       <p class="count-text ">Winning Amount Distributed</p>
                    </div>
                </div>
                </div>
            </a>
             ...
             <div  class="col-md-3">
                ...
                <div class="counter">
                      <i class="voyager-people fa-2x"></i>
                      <h2 class="timer count-title count-number" data-to="{{$user_referral_count}}" data-speed="1500"> ₹ </h2>
                       <p class="count-text ">Signups Using Referral Code</p>
                    </div>
                </div>
                </div>
            </a>
            ...
            <div  class="col-md-3">
                ...
                <div class="col">
                <div class="counter">
                      <i class="voyager-gift fa-2x"></i>
                      <h2 class="timer count-title count-number" data-to="{{$user_referral_amount}}" data-speed="1500"> ₹ </h2>
                       <p class="count-text ">Signup Amount Distributed</p>
                    </div>
                </div>
                </div>
            </a>
